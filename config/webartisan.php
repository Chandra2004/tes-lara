...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Password required to access Webartisan. Set this in your .env file.
    | When set, users must enter this password before accessing the terminal.
    | Leave empty to allow unrestricted access (not recommended in production).
    |
    */

    'password' => env('WEBARTISAN_PASSWORD', null),
    ...
    */
    ...
    'middleware' => [\App\Http\Middleware\WebartisanAuth::class],
